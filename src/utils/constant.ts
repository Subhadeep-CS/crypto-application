...
export const COINS_TABLE_HEADER:string[] =[
    "Rank","Coin","Price", "1h","24h","7d","30d","24h Volume","Market Cap","FDV","Market Cap/FDV","Last 7 Days"
]

export const PAGE_LIMIT:string="50"